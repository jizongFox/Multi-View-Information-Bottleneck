...
class IICTrainer(MVInfoMaxTrainer):
    def __init__(self, beta_start_value=1e-3, beta_end_value=1,
                 beta_n_iterations=100000, beta_start_iteration=50000, num_clusters=10, resample=False, mib=False,
                 **params):
    ...
    def _compute_loss(self, data):
        ...
        skl = 0
        if self._mib:
            skl = (self._kl(p1, p2) + self._kl(p2, p1)) / 2
